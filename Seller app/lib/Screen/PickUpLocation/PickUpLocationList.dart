...
class StatePickUpLocation extends State<PickUpLocationList>
  ...
  void initState() {
    ...
    pickUpLocationListProvider = Provider.of<PickUpLocationProvider>(
      context,
      listen: false,
    );
  ...
  void _loadMoreLocations() {
    if (pickUpLocationListProvider!.locationOffset <
      ...
      context.read<PickUpLocationProvider>().getPickUpLocations(
        context,
        3,
        update: setStateNow,
      );
  ...
  Future<void> _refresh() {
    ...
    return pickUpLocationListProvider!.getPickUpLocations(
      context,
      3,
      update: setStateNow,
    );
