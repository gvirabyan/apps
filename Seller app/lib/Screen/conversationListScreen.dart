      ...
      builder: (context, state) {
        if (state is PersonalConverstationsFetchSuccess) {
          if (state.personalConversations.isEmpty) {
            return Center(
              child: Text(
                noMessagesKey.translate(context: context),
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              children: state.personalConversations.map((personalChatHistory) {
                ...
                return ListTile(
                  ...
                  trailing: (unreadMessages.isNotEmpty && unreadMessages != '0')
                      ? CircleAvatar(
                          radius: 14,
                          child: Text(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(children: [_buildPersonalConversationsContainer()]),
      ),
    );
  }
}
