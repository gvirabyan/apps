                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: providerRequiestForData,
    ...
    ApiBaseHelper()
        ...
        .then(
          (getdata) async {
            ...
            if (!error) {
              var systemSettings = getdata['data']['system_settings'];
              if (systemSettings != null && systemSettings.isNotEmpty) {
                var data = systemSettings[0];
                supportedLocale = data["supported_locals"] ?? 'en';
                ...
                AI_SETTINGS_STATUS = data['ai_settings_status'].toString();
