...
getCommanInputTextField(
  ...
  return Container(
    ...
    child: Padding(
      ...
      child: TextFormField(
        // Multilingual: keep name/tags fields LTR (cursor on the left) for
        // ALL content languages, including Arabic/Urdu — so the cursor never
        // auto-flips based on typed characters.
        textDirection:
            (index == 1 || index == 3) ? TextDirection.ltr : null,
        onFieldSubmitted: (v) {
