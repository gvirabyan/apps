...
selectZipcodeGroupDialog(BuildContext context, Function update) async {
          ...
          builder: (BuildContext context, setStater) {
            ...
            return Column(
              ...
              children: [
                ...
                const SizedBox(height: 5),
                Expanded(
                  child: editProvider!.zipcodeSearchGroupsList.isEmpty
                      ? Center(
                          child: Text(
                      ...
                      : SingleChildScrollView(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: () {
                              return editProvider!.zipcodeSearchGroupsList
                                  .asMap()
                                  .map(
                                    (index, element) => MapEntry(
                                      ...
                                      InkWell(
                                        onTap: () {
                                          final isSelected = editProvider!
                                              .selectedZipcodeGroups
                                              .any((g) => g.id == element.id);

                                          if (isSelected) {
                                            editProvider!.selectedZipcodeGroups
                                                .removeWhere(
                                                  (g) => g.id == element.id,
                                                );
                                          } else {
                ...
                Row(
                  ...
                  children: [
                    TextButton(
                      ...
                      onPressed: () {
                        editProvider!.selectedZipcodeGroups.clear();
                        context.read<ZipcodeProvider>().searchString = '';
                        update();
