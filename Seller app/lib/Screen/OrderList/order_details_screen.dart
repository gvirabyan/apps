          ...
          body: orderFromIdLoadError
              ? Center(
                  child: ErrorContainer(
                    ...
                    errorMessage: 'somethingMSg'.translate(context: context),
                  ),
                )
          ...
          child: PopScope(
            ...
            child: Scaffold(
                        ...
                        return BottomAppBar(
                          child: Padding(
                            ...
                            child: MaterialButton(
                              ...
                              child: Text(
                                  'Create Parcel'.translate(context: context)),
                            ),
                          ),
                        );
                      }),
              appBar: AppBar(
                ...
                title: Text('ORDER_DETAILS'.translate(context: context))
                    .color(white),
                bottom: (!order!.isDigitalOrder)
                    ? TabBar(
                        tabs: [
                          Tab(
                            child: Text(
                                    'ORDER_DETAILS'.translate(context: context))
                                .color(white),
                          ),
                          Tab(
