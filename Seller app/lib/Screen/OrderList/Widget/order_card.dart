        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              if ((widget.order.cityName != null &&
                      widget.order.cityName!.isNotEmpty) ||
                  (widget.order.areaName != null &&
                ...
                Row(
                  children: [
                    ...
                    Text(
                      [
                        if (widget.order.areaName != null &&
                            widget.order.areaName!.isNotEmpty)
                          widget.order.areaName!,
                        if (widget.order.cityName != null &&
                            widget.order.cityName!.isNotEmpty)
                          widget.order.cityName!,
                      ].join(', '),
                    ).size(10).color(const Color.fromARGB(255, 80, 80, 80)),
                  ],
                ),
            ],
          ),
