        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text('select_delivery_boy'.translate(context: context))
                    .size(20),
                const CloseButton()
              ],
            ),
            ...
            builder: (context, state) {
              ...
              if (state is FetchDeliveryboySuccess) {
                if (state.result.deliveryBoys.isEmpty) {
                  return Center(
                      child: Text("NO_DEL_BODY".translate(context: context)));
                }
                return Expanded(
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
            hintText: 'search_delivery_boy'.translate(context: context),
            filled: true,
