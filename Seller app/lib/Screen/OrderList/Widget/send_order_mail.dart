    ...
    return BlocListener<SendMailCubit, SendMailState>(
      listener: (context, state) {
        if (state is SendMailSuccess) {
          setSnackbar('SEND_SUCCESS'.translate(context: context), context,
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text('send_email'.translate(context: context)),
        ),
        body: Form(
          key: _formKey,
              ...
              child: Column(
                ...
                children: [
                  ...
                  buildField(
                    ...
                    title: 'Subject'.translate(context: context),
                    hintText: ''.translate(context: context),
                  ),
                  const SizedBox(
                    height: 15,
                  ),
                  buildField(context,
                      ...
                      hintText:
                          'Write something...'.translate(context: context),
                      linesNoLimit: true),
                  const SizedBox(
                    height: 15,
                  ),
