...
class ConsignmentCard extends StatelessWidget {
  ...
  _onTapDelete(BuildContext context) async {
    var response = await showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text('delete_consignment'.translate(context: context)),
          content:
              Text('delete_consignment_message'.translate(context: context)),
          actions: [
            TextButton(
                onPressed: () {
            ...
            TextButton(
                ...
                child: Text('Delete'.translate(context: context))),
          ],
        );
      },
    );
              ...
              listener: (context, state) {
                ...
                if (state is DeleteConsignmentSuccess) {
                  if (state.id == consignment.id) {
                    ...
                    setSnackbar(
                        'DELETE_CONSIGNMENT_SUCCESSFULY'
