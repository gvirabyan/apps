...
sellerDeliverableCityTypeDialog(BuildContext context, Function setState) async {
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          "SELECT_DELIVERABLE_CITY_TYPE".translate(
                            context: context,
                          ),
                          style: Theme.of(
                            context,
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          InkWell(
                            onTap: () {
                              profileProvider!.deliverableCityType = '0';
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    if (profileProvider!.deliverableCityType ==
                                        '0')
                          ...
                          InkWell(
                            onTap: () {
                              profileProvider!.deliverableCityType = '1';
                              profileProvider!.selectedCityGroups.clear();
                              profileProvider!.deliverableCitiesGroupIds = '';
                              Navigator.of(context).pop();
                              setState();
