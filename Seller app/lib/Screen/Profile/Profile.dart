...
class StateProfile extends State<Profile> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: GradientAppBar("EDIT_PROFILE_LBL".translate(context: context)),
      body: Stack(
        children: <Widget>[
          bodyPart(),
        ...
        child: AppBtn(
          ...
          onBtnSelected: () async {
            ...
            if (form.validate()) {
              ...
              profileProvider!.latitutute = profileProvider!.latitututeC!.text;
                  ...
                  child: Column(
                    children: [
                      ...
                      CommonField(
                        ...
                        labelText: "CONFIRMPASSHINT_LBL".translate(
                          context: context,
                        ),
                        isObscureText: !profileProvider!.showPassword,
                        suffixIcon: IconButton(
