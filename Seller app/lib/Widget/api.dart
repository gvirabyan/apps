...
final Uri getCitiesGroupApi = Uri.parse('${baseUrl}get_cities_group');
...
final Uri getZipcodesGroupApi = Uri.parse('${baseUrl}get_zipcodes_group');
...
final Uri bulkDeleteProductsApi = Uri.parse('${baseUrl}bulk_delete_products');
...
//AI Description Generation APIs
final Uri generateProductDescriptionApi = Uri.parse(
  "${baseUrl}generate_product_description",
);
final Uri suggestProductPromptsApi = Uri.parse(
  "${baseUrl}suggest_product_prompts",
);
