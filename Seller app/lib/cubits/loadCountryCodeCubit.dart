...
import 'package:sellermultivendor/Model/countryCodeModel.dart';
import 'package:sellermultivendor/Repository/appSettingsRepository.dart';
import 'package:sellermultivendor/Repository/countryCodeRepository.dart';
  ...
  Future<void> loadAllCountryCode(final BuildContext context) async {
    try {
      ...
      final CountryCodeModel country =
          await countryCodeRepository.getCountryByCountryCode(
              context, AppSettingsRepository.appSettings.defaultCountryCode);
