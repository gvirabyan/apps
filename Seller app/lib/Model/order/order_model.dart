...
//GETTERS
  ...
  factory OrderModel.fromJson(Map<String, dynamic> json) {
    return OrderModel(
      ...
      postalCode: (json["pin_code"] ?? json["pincode"] ?? json["zip_code"] ??
              json["zipcode"])
          ?.toString() ??
          '',
    );
...
class OrderItem {
  ...
  factory OrderItem.fromJson(Map<String, dynamic> json) {
    return OrderItem(
      ...
      returnItemImage: json['return_item_image'] == null
          ? []
          : List<dynamic>.from(json["return_item_image"]!.map((x) => x)),
      itemattachments: json['attachment'] == null
          ? []
          : (json['attachment'] is List
              ? List<String>.from(json['attachment'].map((x) => x.toString()))
              : [json['attachment'].toString()]),
      // itemattachments: json["item_attachment"] == null
      //     ? []
      //     : List<String>.from(json["item_attachment"]!.map((x) => x)),
    );
  }
  ...
  Map<String, dynamic> toJson() => {
        ...
        "return_reason": returnReason,
        "return_item_image": returnItemImage.map((x) => x).toList(),
        "attachment": itemattachments!.map((x) => x.toString()).toList()
      };
