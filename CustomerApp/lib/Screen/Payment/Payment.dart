  ...
  void initState() {
    ...
    Future.delayed(
      ...
      () {
        ...
        print('[PAYMENT_DEBUG] paymentMethodList set, length = ${context.read<PaymentProvider>().paymentMethodList.length}');
        print('[PAYMENT_DEBUG] paymentMethodList = ${context.read<PaymentProvider>().paymentMethodList}');
      },
    );
    if (widget.msg != '') {
                                        ...
                                        children: [
                                          ...
                                          ListView.builder(
                                            ...
                                            itemCount: context
                                                ...
                                                .length,
                                            itemBuilder: (context, index) {
                                              print('[PAYMENT_DEBUG] ListView index=$index, payModel.length=${context.read<PaymentProvider>().payModel.length}, paytabs=${context.read<PaymentProvider>().paytabs}');
                                              if (index == 0 &&
                                                  context
                                                      .read<PaymentProvider>()
                                                      .cod &&
