...
Widget getAssigned(String? asDate, String? cDate, BuildContext context) {
  return cDate == null
      ? Row(
          crossAxisAlignment: CrossAxisAlignment.end,
          children: [
            Column(
              ...
              children: [
                SizedBox(
                  ...
                  child: VerticalDivider(
                    thickness: 2,
                    color: asDate == null ? Colors.grey : colors.primary,
                  ),
                ),
                Icon(
                  Icons.circle,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'ORDER_ASSIGNED'.translate(context: context),
                    style: const TextStyle(fontSize: textFontSize8),
                  ),
                  Text(
                    asDate ?? ' ',
