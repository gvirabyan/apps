    ...
    if (isNetworkAvail) {
      ...
      try {
        ...
        if (!error) {
          ...
          print('[PAYMENT_DEBUG] Full payment keys: ${payment.keys.toList()}');
          print('[PAYMENT_DEBUG] paytabs_payment_method raw value: ${payment['paytabs_payment_method']}');
          ...
          paytabs = payment['paytabs_payment_method'] == '1' ? true : false;
          print('[PAYMENT_DEBUG] paytabs bool = $paytabs');
          ...
          if (paytabs) {
            context.read<CartProvider>().paytabsProfileId =
                payment['paytabs_profile_id'];
            context.read<CartProvider>().paytabsServerKey =
                payment['paytabs_server_key'];
            context.read<CartProvider>().paytabsMode =
                payment['paytabs_payment_mode'];
            context.read<CartProvider>().paytabsRegion =
                payment['paytabs_region'];
          }
          if (cod) {
          ...
          print('[PAYMENT_DEBUG] paymentMethodList.length = ${paymentMethodList.length}');
          print('[PAYMENT_DEBUG] paymentMethodList = $paymentMethodList');
          ...
          print('[PAYMENT_DEBUG] payModel.length = ${payModel.length}');
        } else {}
