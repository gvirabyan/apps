...
import 'package:deliveryboy_multivendor/Model/countryCodeModel.dart';
import 'package:deliveryboy_multivendor/Repository/AppSettingsRepository.dart';
import 'package:deliveryboy_multivendor/Repository/countryCodeRepository.dart';
  ...
  Future<void> loadAllCountryCode(final BuildContext context) async {
    try {
      ...
      final CountryCodeModel country = await countryCodeRepository
          .getCountryByCountryCode(context, AppSettingsRepository.appSettings.defaultCountryCode);
